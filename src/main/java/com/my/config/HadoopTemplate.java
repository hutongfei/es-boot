...
//        return getFileInputStream(nameSpace + "/" + fileName);
//    }
    ...
    public InputStream getFileInputStream(String hdfsFile) {
        // 源文件路径
        if (StringUtils.isNotBlank(nameNode)) hdfsFile = nameNode + hdfsFile;
